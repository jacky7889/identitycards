...
export function CardDetails({ id, card, initialStep = 1 }) {
  ...
  const steps = [
    { id: 1, label: "Card Color, Qty & Features" },
  ...
  const handleFileUpload = async (file) => {
    ...
    formData.append('product_type', 'card');
  ...
  const nextStep = async () => {
    if (currentStep === 2) {
      ...
      saveItemToLocalStorage("card", newItem);
      router.push("/cart");
    } else {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/cards" className="text-blue-500 underline">
            Go back to Cards
          </Link>
        </div>
      </div>
          ...
          <>
            ...
            <div className="text-gray-700 mb-6 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <select
                  className="w-full sm:w-40 border border-gray-300 rounded p-2 text-sm md:text-base cursor-pointer focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  onChange={(e) => {
            ...
            <div className="text-gray-700 mb-4 flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-6">
              <p className="font-medium min-w-[100px]">Design Service:</p>
    ...
    <div className="container mx-auto p-4 md:p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 md:gap-12 lg:gap-24 mt-6">
        ...
        <div className="w-full lg:w-[40%] space-y-4 md:space-y-5">
          <div className="relative w-full h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden shadow-md border border-gray-200">
            <Image
              src={`${IMG_URL}/${card.images[0]}`}
              alt={card.card_name}
              fill
